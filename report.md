...
Summarization is an NLP task that has many practical applications in the data-driven age. The goal of summarization is to identify the core concepts of a large text and present those concepts with a low congnitive cost.
